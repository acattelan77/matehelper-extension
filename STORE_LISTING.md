...
It processes page text and page structure locally in the browser only to detect visible URL references and target editing areas. No page content or browsing data is sent anywhere.
